...
class Student extends PHPUnit_Framework_TestCase {
	...
	public function setUp(){
		...
		include_once '/var/www/agile/application/Gos/Model/Student.php';
		include_once '/var/www/agile/application/Gos/Dao/Student.php';
		include_once '/var/www/agile/application/Gos/Controller/Student.php';
	}
	...
	private function gos_unit_bootstrap(){
		...
		$this->req->setItem('ctl','Student');
		$this->req->setItem('act','unitTest');
		$this->obj = new Gos_Controller_Student($this->req);
