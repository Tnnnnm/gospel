...
<html>
    <head>
        <meta charset="utf-8" />
        <title>(<?php echo $suiteResults['pass'],'/', $suiteResults['fail']?>) <?php echo $title?> | lenush Gospel_Unit</title>
    ...
    <body>
        ...
        <footer> Powered by <a href="http://www.ihj.me">lenush</a> Gospel_Unit</footer>
